# -*- coding: utf-8 -*-
"""
Django settings for mfinstop project.
...
class Common(Configuration):
    ...
    INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + AUTHENTICATION_PROVIDER_APPS + LOCAL_APPS
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/mfinstop')
